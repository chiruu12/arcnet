...
- unplug-ai's labeled benchmark samples (12 injection, 6 destructive, 4 leakage) for S5 variants and corpus breadth — confirm import path Day 1.
...
- **Demo**: Beat 3. Timings live in the scenario fixture per `07`.
...
Day 5's "seed rich history" records the replay corpus: **12 incident sessions** = S1 variants ×6 (different poisoned pages) · S5 variants ×3 · S2 ×2 · S0 ×1. Generated by us, said so in the demo. `scripts/seed.py` (Day 3) covers Griffin's *metric* history; corpus recording is a Day-5 runner mode.
...
- Rehearse S1 + S4 as a pair Thu EOD (they're Beats 2–3 back-to-back).
