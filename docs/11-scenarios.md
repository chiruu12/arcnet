...
Phase 5's "seed rich history" records the replay corpus: **12 incident sessions** = S1 variants ×6 (different poisoned pages) · S5 variants ×3 · S2 ×2 · S0 ×1. Generated by us, said so in the demo. `scripts/seed.py` (Phase 3) covers Griffin's *metric* history; corpus recording is a Phase-5 runner mode.
