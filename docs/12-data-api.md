...
| `GET /api/fleet` | — | `[{agent_id, name, role, exposure, model, last_seen, health: {sessions_24h, threats_24h, blocked_24h, cost_24h_usd, anomalies_24h, active_signals}}]` | — (read) |
...
| `POST /api/replay/corpus` (P1) | `{candidate_model}` | scorecard aggregate | `ARCNET_WRITE_SECRET` when set (planned) |
