...
| False positives on spiky-but-normal metrics | Conformal band + noise floor + 5m cooldown; tune on seeded traffic (seed exists Phase 3) |
...
| "Griffin first" inverts on camera | Deterministic S4 choreography (see above); rehearse Phase 3 |
